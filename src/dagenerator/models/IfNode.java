...
public class IfNode extends CodeNode{
    ...
    public IfNode(CodeNode parent, String condition) throws ConditionCleanCodeException{
        super(parent);
    ...
    public final void setCondition(String condition) throws ConditionCleanCodeException{
